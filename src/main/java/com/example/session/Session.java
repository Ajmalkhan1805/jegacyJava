...
public class Session extends Session3270 {
	...
	public static String returnTextWithLegth;
	...
	public String getValueWithLength(int row, int column, int length) throws Exception{
		
		return readPosition(row, column, length);
